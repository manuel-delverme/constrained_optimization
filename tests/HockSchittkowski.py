...
# JGP TODO: 
# Some test problems in this collection have typos
# Some problems in this collection do not match the initialization suggested in APMonitor
# This leads to some cases being initialized at a fixed point
# This test-bed needs significant work
...
class Hs01(Hs):
    ...
    optimal_solution = torch.tensor(0.)
...
class Hs08(Hs):
    ...
    def constraints(x):
        h0 = lambda x: x[0] ** 2 + x[1] ** 2 - 25
        h1 = lambda x: x[0] * x[1] - 9
